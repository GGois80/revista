...
<html lang="pt" dir="ltr">
    ...
    <body>
        <?php
         ...
         <div id="noticia" class="not-index">
             <img src="../imgnot/<?php echo $not['foto'];?>"/>
    ...
    <!--**************exibição dos comentarios****************-->
        <?php
                $sql2 = "SELECT u.id_usuario AS idusuario, u.nome, c.id_com AS idcoment, c.comentario, c.data_coment, c.id_usucom, c.id_comentnot FROM usuario u INNER JOIN comentarios c ON u.id_usuario = c.id_usucom WHERE c.id_comentnot = $idnot AND c.moderado = 2  ORDER BY c.comentario DESC";
