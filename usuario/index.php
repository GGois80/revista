<html>
  ...
  <body>
    ...
    ?>
      <h2>Bem vindo! <?php echo $_SESSION['nome'];?> usuario</h2><br/>
        <div class="conteiner noticias">
            <div class="content">
              <?php
                  $sql="SELECT u.id_usuario AS idusuario, u.nome,u.moderuser,
                  n.id_not AS idnoticia, n.texto, n.foto, n.data_noticia,n.titulo FROM usuario u INNER JOIN noticia n ON u.id_usuario = n.id_usunot";
